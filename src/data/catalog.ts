export type Service = {
  ...
  price: number;
  description: string;
  group: "local" | "massage" | "complex" | "spa" | "travel" | "kids" | "subscription";
  /**
...
export const services: Service[] = [
  // Локальные зоны — отдельная категория в официальном прайсе (идёт перед
  // «Массаж»), не подмножество полнотельных массажей. СТРОГАЯ ЗАДАЧА
  // 2026-09-13: 3 услуги, каждая с вариантами 60/90 мин.
  {
    id: "local-feet-60",
