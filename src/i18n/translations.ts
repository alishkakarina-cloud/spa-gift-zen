...
const ru = {
  ...
  cert: {
    ...
    saveManuallyToast: "Не удалось сохранить автоматически — нажмите «Скачать сертификат»",
...
const kz = {
  ...
  cert: {
    ...
    saveManuallyToast: "Автоматты сақтау сәтсіз аяқталды — «Сертификатты жүктеу» түймесін басыңыз",
...
const en = {
  ...
  cert: {
    ...
    saveManuallyToast: "Couldn't save automatically — tap \"Download certificate\"",
