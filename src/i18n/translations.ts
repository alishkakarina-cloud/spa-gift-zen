...
const ru = {
  ...
  home: {
    ...
    spaMenuKokshetauButton: "Скачать меню СПА Кокшетау",
    spaMenuPetropavlovskButton: "Скачать меню СПА Петропавловск",
  ...
  cert: {
    ...
    buyerNameLabel: "Имя",
    buyerLastNameLabel: "Фамилия",
    buyerPhoneLabel: "Номер телефона",
    buyerEmailLabel: "E-mail (необязательно)",
    ...
    rowNominal: "Номинал",
    nominalLineLabel: "Сертификат на сумму {amount}",
    rowBranch: "Филиал",
    rowTotal: "Итого",
    cardBranch: "Филиал",
    ...
    errBuyerLastNameRequired: "Укажите фамилию",
    ...
    recipientLastNameLabel: "Фамилия получателя — обязательно",
    ...
    payIntro: "Выберите способ оплаты и подтвердите сумму",
    payMethodTitle: "Способ оплаты",
    payMethodQr: "Оплатить по QR",
    payMethodPhone: "Оплатить по номеру телефона",
    payPhoneLabel: "Номер телефона Kaspi",
    payPhonePlaceholder: "87001234567",
    payPhoneHint: "Формат 8XXXXXXXXXX — без +7, пробелов и скобок",
    errPayPhoneInvalid: "Введите номер в формате 8XXXXXXXXXX (11 цифр)",
    showQrButton: "Показать QR для оплаты",
    sendPhoneRequestButton: "Отправить запрос на оплату",
    payAwaitingQr:
      "Отсканируйте QR в приложении Kaspi.kz — сертификат сформируется автоматически, как только оплата подтвердится.",
    payAwaitingPhone: "Проверьте уведомление в приложении Kaspi Pay на номере {phone}.",
    payAwaitingNote: "Обычно это занимает несколько секунд.",
    errInvoiceCreateFailed: "Не удалось создать счёт на оплату. Попробуйте ещё раз.",
    errApipayNotConfigured: "Приём платежей ещё не подключён (не задан ключ ApiPay). Обратитесь к администратору.",
    errPhoneNotRegistered: "Этот номер не зарегистрирован в Kaspi Pay. Проверьте номер или оплатите по QR.",
    errRateLimited: "Слишком много запросов. Попробуйте через минуту.",
    errPaymentValidation: "Сервис оплаты не принял номер или сумму. Проверьте данные и попробуйте снова.",
    payTimeoutMessage: "Оплата пока не подтверждена. Проверьте статус в приложении Kaspi или попробуйте снова.",
    checkStatusButton: "Проверить статус",
    changeMethodButton: "Изменить способ оплаты",
    paymentConfirmedTitle: "Оплата подтверждена",
    paymentConfirmedText: "Нажмите кнопку ниже, чтобы получить сертификат — он сразу сохранится в вашу галерею.",
    getCertificateButton: "Я оплатил",
    ...
    savedToGalleryToast: "Сохранено в галерее",
    saveManuallyToast: "Файл скачан — сохраните его в галерею вручную",
    ...
    nextButton: "Далее",
    giftButton: "Подарить",
    addExtraServicesButton: "Выбрать доп.услуги",
    returnToOrderButton: "Вернуться к оформлению",
  ...
  footer: {
    ...
    legalCookie: "Политика обработки cookie-файлов",
...
const kz = {
  ...
  home: {
    ...
    spaMenuKokshetauButton: "Көкшетау СПА-мәзірін жүктеу",
    spaMenuPetropavlovskButton: "Петропавл СПА-мәзірін жүктеу",
  ...
  cert: {
    ...
    buyerNameLabel: "Аты",
    buyerLastNameLabel: "Тегі",
    buyerPhoneLabel: "Телефон нөмірі",
    buyerEmailLabel: "E-mail (міндетті емес)",
    ...
    rowNominal: "Номинал",
    nominalLineLabel: "{amount} сомасына сертификат",
    rowBranch: "Филиал",
    rowTotal: "Барлығы",
    cardBranch: "Филиал",
    ...
    errBuyerLastNameRequired: "Тегіңізді көрсетіңіз",
    ...
    recipientLastNameLabel: "Алушының тегі — міндетті",
    contactTypePhone: "Телефон",
    contactTypeEmail: "E-mail",
    ...
    payIntro: "Төлем тәсілін таңдап, соманы растаңыз",
    payMethodTitle: "Төлем тәсілі",
    payMethodQr: "QR арқылы төлеу",
    payMethodPhone: "Телефон нөмірі арқылы төлеу",
    payPhoneLabel: "Kaspi телефон нөмірі",
    payPhonePlaceholder: "87001234567",
    payPhoneHint: "Формат 8XXXXXXXXXX — +7, бос орын және жақшасыз",
    errPayPhoneInvalid: "8XXXXXXXXXX форматында нөір енгізіңіз (11 сан)",
    showQrButton: "Төлеу үшін QR көрсету",
    sendPhoneRequestButton: "Төлем сұрауын жіберу",
    payAwaitingQr:
      "Kaspi.kz қосымшасында QR-кодты сканерлеңіз — төлем расталған бойда сертификат автоматты түрде қалыптасады.",
    payAwaitingPhone: "Kaspi Pay қосымшасындағы {phone} нөміріне келген хабарламаны тексеріңіз.",
    payAwaitingNote: "Әдетте бұл бірнеше секунд алады.",
    errInvoiceCreateFailed: "Төлем шотын құру мүмкін болмады. Қайталап көріңіз.",
    errApipayNotConfigured: "Төлемдерді қабылдау әлі қосылмаған (ApiPay кілті орнатылмаған). Әкімшіге хабарласыңыз.",
    errPhoneNotRegistered: "Бұл нөмір Kaspi Pay-де тіркелмеген. Нөмірді тексеріңіз немесе QR арқылы төлеңіз.",
    errRateLimited: "Тым көп сұраныс. Бір минуттан кейін қайталап көріңіз.",
    errPaymentValidation: "Төлем сервисі нөмірді немесе соманы қабылдамады. Деректерді тексеріп, қайталаңыз.",
    payTimeoutMessage: "Төлем әлі расталған жоқ. Kaspi қосымшасынан статусты тексеріңіз немесе қайта көріңіз.",
    checkStatusButton: "Статусты тексеру",
    changeMethodButton: "Төлем тәсілін өзгерту",
    paymentConfirmedTitle: "Төлем расталды",
    paymentConfirmedText: "Сертификатты алу үшін төмендегі түймені басыңыз — ол бірден галереяңызға сақталады.",
    getCertificateButton: "Мен төледім",
    ...
    savedToGalleryToast: "Галереяға сақталды",
    saveManuallyToast: "Файл жүктелді — оны галереяға өзіңіз сақтаңыз",
    ...
    backButton: "Артқа",
    nextButton: "Келесі",
    addExtraServicesButton: "Қосымша қызмет таңдау",
    returnToOrderButton: "Тапсырысқа оралу",
    payButton: "Төлеу",
  ...
  footer: {
    ...
    legalCookie: "Cookie файлдарын өңдеу саясаты",
...
const en = {
  ...
  home: {
    ...
    spaMenuKokshetauButton: "Download SPA menu — Kokshetau",
    spaMenuPetropavlovskButton: "Download SPA menu — Petropavlovsk",
  ...
  cert: {
    ...
    buyerLastNameLabel: "Last name",
    buyerPhoneLabel: "Phone number",
    buyerEmailLabel: "E-mail (optional)",
    ...
    nominalLineLabel: "Certificate for {amount}",
    rowBranch: "Branch",
    rowTotal: "Total",
    cardBranch: "Branch",
    ...
    errBuyerLastNameRequired: "Enter your last name",
    ...
    recipientLastNameLabel: "Recipient's last name — required",
    ...
    payIntro: "Choose a payment method and confirm the amount",
    payMethodTitle: "Payment method",
    payMethodQr: "Pay by QR",
    payMethodPhone: "Pay by phone number",
    payPhoneLabel: "Kaspi phone number",
    payPhonePlaceholder: "87001234567",
    payPhoneHint: "Format 8XXXXXXXXXX — no +7, spaces, or brackets",
    errPayPhoneInvalid: "Enter the number as 8XXXXXXXXXX (11 digits)",
    showQrButton: "Show QR to pay",
    sendPhoneRequestButton: "Send payment request",
    payAwaitingQr:
      "Scan the QR in the Kaspi.kz app — the certificate will be generated automatically once the payment is confirmed.",
    payAwaitingPhone: "Check the Kaspi Pay app notification on {phone}.",
    payAwaitingNote: "This usually takes a few seconds.",
    errInvoiceCreateFailed: "Could not create the payment invoice. Please try again.",
    errApipayNotConfigured: "Payments aren't connected yet (ApiPay key missing). Please contact the administrator.",
    errPhoneNotRegistered: "This number isn't registered with Kaspi Pay. Check the number or pay by QR instead.",
    errRateLimited: "Too many requests. Please try again in a minute.",
    errPaymentValidation: "The payment service rejected the number or amount. Please check the details and try again.",
    payTimeoutMessage: "Payment hasn't been confirmed yet. Check the status in the Kaspi app or try again.",
    checkStatusButton: "Check status",
    changeMethodButton: "Change payment method",
    paymentConfirmedTitle: "Payment confirmed",
    paymentConfirmedText: "Tap the button below to get your certificate — it will be saved to your gallery right away.",
    getCertificateButton: "I've paid",
    step6Eyebrow: "Paid",
    ...
    savedToGalleryToast: "Saved to your gallery",
    saveManuallyToast: "File downloaded — save it to your gallery manually",
    ...
    backButton: "Back",
    nextButton: "Next",
    addExtraServicesButton: "Add extra services",
    returnToOrderButton: "Return to your order",
    payButton: "Pay",
    savingButton: "Saving…",
    payTotal: "Total due",
    cardTo: "To",
