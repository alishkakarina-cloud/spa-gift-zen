...
const ru = {
  ...
  cert: {
    ...
    errAmountNotWhole: "Сумма сертификата должна быть целым числом тенге, без копеек",
...
const kz = {
  ...
  cert: {
    ...
    errAmountNotWhole: "Сертификат сомасы тиын болмай, тұтас теңге болуы керек",
...
const en = {
  ...
  cert: {
    ...
    errAmountNotWhole: "The certificate amount must be a whole number of tenge, no kopecks",
