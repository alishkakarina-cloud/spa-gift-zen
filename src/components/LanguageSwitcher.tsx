...
export function LanguageSwitcher({ className = "" }: Props) {
  ...
  return (
    <div className={className}>
      {/* Separate "anchor" div always carries just `relative`, independent of whatever
          position utility the caller passes via `className` (absolute/fixed/static) —
          combining them on one element was a real bug: conflicting position classes
          on the same div silently broke absolute positioning in the hero section. */}
