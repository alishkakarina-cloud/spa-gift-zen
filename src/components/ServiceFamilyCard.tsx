    ...
    >
      ...
      <div className="min-w-0 shrink px-3 py-2">
        {/* Цена отдельной строкой сверху убрана (правка владельца
            ...
            max-content ширины переключателя вариантов (DurationSwitch), а
            у него своя внутренняя flex-wrap. На узком экране (375px) для
            услуги с 3 вариантами (например Oil-массаж, 60/90/120 мин) эта
            max-content ширина сама по себе шире всей карточки — flex-1 фото
            слева получало отрицательный остаток и схлопывалось в 0px
