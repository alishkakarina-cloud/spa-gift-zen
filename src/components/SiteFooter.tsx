 ...
 * контакты → юр. ссылки → копирайт → платёжные иконки. У layan «Мы
 * в Instagram» физически лежит внутри <footer> самым первым блоком, а не
 * отдельной секцией перед ним.
 *
 * Кнопка «Купить сертификат» здесь была правкой 2026-08-22 убрана совсем —
 * теперь на каждой странице, где рендерится этот футер, уже есть свой вход
 * в покупку выше по странице (hero на «/», сама секция «Выбор сертификата»
 * на /offers) — дублировать его в футере не нужно.
 *
