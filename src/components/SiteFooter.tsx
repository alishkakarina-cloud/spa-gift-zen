 ...
 * вела на устаревший /offers (не синхронизированный с актуальным флоу
 * оформления на /certificate) и дублировала кнопку в hero, которая и
 * остаётся единственным входом в покупку.
 *
