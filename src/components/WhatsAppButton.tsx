...
// TODO: replace with the real salon WhatsApp number (international format, digits only).
...
export function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="bg-gold text-forest-deep fixed right-5 bottom-5 z-40 flex h-14 w-14 items-center justify-center rounded-full shadow-[0_8px_24px_rgba(0,0,0,0.4)] transition-transform hover:scale-105 sm:right-7 sm:bottom-7"
    >
